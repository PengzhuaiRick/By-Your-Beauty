...
-(void)setupUI{
    ...
    UILabel* lab = [[UILabel alloc]initWithFrame:CGRectMake(15, CGRectGetMaxY(imgview.frame)+20, KMainScreenWidth-30, KMainScreenWidth*15/320)];
    lab.font = [UIFont systemFontOfSize:KMainScreenWidth*13/320];
    lab.numberOfLines = 0;
    lab.lineBreakMode = 0;
