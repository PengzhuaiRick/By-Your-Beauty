...
@interface UNIAlbumXibController ()<UIScrollViewDelegate>
...
@implementation UNIAlbumXibController
...
-(void)startRequest{
    __weak UNIAlbumXibController* myself = self;
